...
int errno, status, cpid; //global bc used in multiple functions
...
int main (int argc, char **argv)
{
  ...
  int clientFD = accept(sockFD, (struct sockaddr *) &mySockAddr, &hostLen); //clientFD = fd of connected socket 
  ...
  set_input_mode (); //needed?? in sever or both or none?
